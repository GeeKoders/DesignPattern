...
public class App {
	 ...
	 * ---------------------------------------------------
	 * 
	 * What is the motivation? We can have an abstraction of the system using
	 * interfaces
	 * 
	 * List<String> l = new ArrayList<>();
	 * 
	 * Sometimes --> we want to implement that interface but just for the sake
	 * of some methods defined in by that interface BUT we have to implement all
	 * the methods "fat interfaces"
	 * 
	 * ----------------------------------------------------
	 * 
	 ...
	 * 
	 * - when we can, we should break our interfaces in many smaller ones, so
	 * they better satisfy the exact needs of our clients
	 * 
	 */

	public static void main(String[] args) {
		Tree binarySearchTree = new BalancedTree();
